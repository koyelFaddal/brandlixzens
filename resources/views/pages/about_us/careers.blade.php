...
<style>
    ...
    .form-group-new-old-first label {
        ...
        color: #444;
        display: flex;
        align-items: center; /* Align icon and label text in the center vertically */
        margin-bottom: 8px;
        display: inline-block;
    }
    
    .form-group-new-old-first label i {
        margin-right: 8px; /* Add some spacing between the icon and label text */
    ...
    .form-row-new-old-first input {
        width: 100%; /* Take full available width */
        max-width: 100%; /* Remove max width constraint for full coverage */
        padding: 12px 16px;
        border: 1px solid #ddd;
        border-radius: 8px;
        font-size: 16px;
    ...
    .form-group-new-old-first input:focus, 
    .form-group-new-old-first textarea:focus {
        border-color: #4a90e2;
        box-shadow: 0 0 8px rgba(74, 144, 226, 0.2);
        background: #fff;
    }
    
    .form-group-new-old-first input[type="file"] {
        padding: 5px;
    }
    ...
    #submit-form-carrer {
        ...
        border: none;
        border-radius: 10px;
        background-image: linear-gradient(45deg, #f05656, #f09456);
        color: #fff;
        font-size: 18px;
        font-weight: bold;
        cursor: pointer;
    ...
    #submit-form-carrer:hover {
        background-image: linear-gradient(45deg, #e24646, #d47b47);
    ...
    /* Typography and Animation Enhancements */
    body {
    ...
    #submit-form-carrer:active {
        transform: translateY(2px);
    }
    
    /* Adding Animation to Input Fields */
    .form-group-new-old-first input, .form-group-new-old-first textarea {
    ...
    .filter-btn:hover, .filter-btn.active {
        background-color: #f05656; /* Maintain the hover effect */
        color: #fff;
        border-color: #f05656;
        ...
        <div id="apply-modal" class="modal" style="display: none;">
            ...
            <div class="career-container">
                <div class="banner">
                    ...
                    <p>We're looking for passionate people to join us. We value clear communication, full ownership, and responsibility.</p>
                </div>
                <div class="filter-container">
                    ...
                    <button class="filter-btn" data-category="customer-service">Customer Service</button>
                ...
                <div class="no-openings" id="no-openings" style="display: none;">
                    <h2>Sorry, no openings in this section right now.</h2>
                    <p>Check back later, or explore other available opportunities.</p>
